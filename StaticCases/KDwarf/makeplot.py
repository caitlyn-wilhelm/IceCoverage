...
for x,dest in enumerate(case_list):
    ...
    if dest == "WarmStart/":
        filename = "KDwarf_WarmStart.bpa"
    else:
         filename = "KDwarf_ColdStart.bpa"
    ...
    axs[0].set_title("K Dwarf, Warm Start", fontsize = 16)
    axs[1].set_title("K Dwarf, Cold Start", fontsize = 16)
