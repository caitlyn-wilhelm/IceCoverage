...
for x,dest in enumerate(case_list):
    ...
    if dest == "WarmStart/":
        filename = "FDwarf_WarmStart.bpa"
    else:
         filename = "FDwarf_ColdStart.bpa"
    ...
    axs[0].set_title("F Dwarf, Warm Start", fontsize = 16)
    axs[1].set_title("F Dwarf, Cold Start", fontsize = 16)
...
if (sys.argv[1] == 'pdf'):
    plt.savefig('F_StaticCompare' + '.pdf')
if (sys.argv[1] == 'png'):
    plt.savefig('F_StaticCompare' + '.png')
